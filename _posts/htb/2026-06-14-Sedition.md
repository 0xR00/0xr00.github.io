...
> Está máquina solo es compatible con Virtualbox. Si quereís usar Vmware debereís de configurar la interfaz de red. Para obtener acceso al sistema por el GRUB.
{: .prompt-info }
